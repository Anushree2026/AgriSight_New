...
def generate_frames():
    ...
    while True:
        ...
        if (
                detected_in_frame
                and current_time - last_saved_time > SAVE_INTERVAL
        ):
            ...
            try:
                ...
                with app.app_context():
                    ...
                    new_detection = Detection(
                        detected_value=detected_in_frame
                    )
        ...
        # ==================================================
        # Encode JPEG (lower quality = faster stream)
        # ==================================================
        ...
        if not camera_running and cap is not None:
            cap.release()
            cap = None
